...
// What are the different types of modules in Node.js?
    ...
    // 2. User Modules: User modules are created by user. We can create our own modules and use them in our applicaiton where we need.
        //example: custom modules, third party modules etc.
    // ------------------------------------------------------------------------------
// How to create the custom Modules/ User Modules?
    // We can create a custom module in node.js by creating a new file with respective veriables, function and classes. we can export and import any where in the project.
    // Example
        function test(){
            return 'Hello';
        }
...
// Module Systems:
    ...
    // 2. ES6 Modules -- It is moderan java script standrad.
...
//How do CommonJS and ES modules differ in Node.js?
    ...
    // File extenstion .js, in Es file extention is .js and .mjs with type: module in package.json
    // ------------------------------------------------------------------------------