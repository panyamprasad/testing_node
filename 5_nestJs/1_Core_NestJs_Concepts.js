...
//          2. Instead of writing everything manually, nestJs provide ready concepts like modules, 
//             controllers and services to make code clear and scalable.
...
//              b. Dependency Injection: Dependency Injection means 
//                 if a class need something like objects it will get it from outside, instead of creating them.
...
//          2. And all business logic will kept in service, for example multiple api's need same logic we can reuse the logic. 
//             That's way we separate the business logic and controller.

//--->5. What is Dependency Injection (VERY IMPORTANT)?
//          1. Dependency Injection is a design pattern, where a class receives its dependencies from outside 
//             instead of creating them itself.
//          2. In nestJs Dependency Injection allows us to inject services into controllers or other services 
