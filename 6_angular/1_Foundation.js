...
//          --> Two-way Binding: Data flows in both directions, from the component to HTML template and HTML to Component. 
...
//                      b. *ngFor: It is used to iterate an array and show the elements dynamically.
//                          It is used to create a list of items.
//                      c. *ngSwitch:
...
//          --> 1. Custom Attribute directives are angular directive.
//          --> 2. Used to modify the behavior and appearance of existing DOM Elements without changing the DOM Structure.
//          --> 3. We use them when the same functionality or styling is needed in multiple places.
//          --> 4. Such as highlighting elements, restricting input, showing tooltips, auto formatting values etc.
//          --> 5. It will improve code reusability, maintainability, and keep components clean.
// --------------------------------------------------------------

//---> Renderer2 Class?
//          --> Renderer2 Class allows us to manipulate the dom without accessing the DOM elements directly.
//          --> It will provide the layer of abstraction between the DOM and component code.
// --------------------------------------------------------------

//---> Decorators:
//          ---> HostListener?
//              --> HostListener is angular Decorator.
//              --> Used this we can listen to event on a host element and we can react on that and execute some actions.
//              --> It helps directives and components to purpose the actions.
//              --> Mainly used this mouseEnter, mouseRemove, Keypress, Focus, Blur like this operations will use this.
