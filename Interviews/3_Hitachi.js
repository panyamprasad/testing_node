...
// 3. Asked After token validation we are called external API's and checking the permission? why we need this validation? in this place it will required or not? I thing so it's not required.
